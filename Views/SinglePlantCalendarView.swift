...
struct SinglePlantCalendarView: View {
...
struct SinglePlantCalendarView_Previews: PreviewProvider {
	
    static var previews: some View {
        SinglePlantCalendarView(plantCreationDate: Date(), plantWateringInterval: TimeInterval(60 * 60 * 24 * 7))
    }
}
